...
window.addEventListener('DOMContentLoaded', () => {
  const scriptTag = document.querySelector('script[src$="reports.js"]');
  const excelUrl = scriptTag.dataset.excelUrl; // Get SharePoint URL from data attribute

  if (!excelUrl) {
    console.error("Excel URL not provided in data-excel-url attribute.");
    return;
  }
